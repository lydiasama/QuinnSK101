...
var appRoutes = [
    { path: 'login', component: _login_login_component__WEBPACK_IMPORTED_MODULE_2__["LoginComponent"], canActivate: [_core_auth_guard__WEBPACK_IMPORTED_MODULE_7__["AuthGuard"]] },
    { path: 'register', component: _register_register_component__WEBPACK_IMPORTED_MODULE_3__["RegisterComponent"], canActivate: [_core_auth_guard__WEBPACK_IMPORTED_MODULE_7__["AuthGuard"]] },
...
/* harmony import */ var _environments_environment_prod__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../environments/environment.prod */ "./src/environments/environment.prod.ts");
...
/* harmony import */ var _core_matrix_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./core/matrix.service */ "./src/app/core/matrix.service.ts");
/* harmony import */ var _shared_modal_modal_config__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./shared/modal/modal-config */ "./src/app/shared/modal/modal-config.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _shared_modal_modal_config__WEBPACK_IMPORTED_MODULE_20__["NgbdModalConfig"]
            ],
            imports: [
                ...
                angularfire2__WEBPACK_IMPORTED_MODULE_4__["AngularFireModule"].initializeApp(_environments_environment_prod__WEBPACK_IMPORTED_MODULE_14__["environment"].firebase),
            ...
            providers: [_core_auth_service__WEBPACK_IMPORTED_MODULE_17__["AuthService"], _core_user_service__WEBPACK_IMPORTED_MODULE_18__["UserService"], _core_auth_guard__WEBPACK_IMPORTED_MODULE_16__["AuthGuard"], _core_matrix_service__WEBPACK_IMPORTED_MODULE_19__["MatrixService"]],
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.generateTime = function () {
        var keyTime = moment__WEBPACK_IMPORTED_MODULE_4__().format('YYMMDD-hhmmss');
        return "QN" + keyTime;
    };
    AuthService.prototype.logUser = function (uid, userName) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var ref = firebase_app__WEBPACK_IMPORTED_MODULE_3__["database"]().ref("login-log/" + _this.generateTime());
            ref.set({
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authService, userService, router, fb) {
        this.authService = authService;
        this.userService = userService;
        this.router = router;
        this.fb = fb;
...
var MainComponent = /** @class */ (function () {
    ...
    MainComponent.prototype.getData = function () {
        var _this = this;
        this.matrixService.getAllData().snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (changes) {
...
var NgbdModalConfig = /** @class */ (function () {
    ...
    NgbdModalConfig.prototype.open = function (message, type, action) {
