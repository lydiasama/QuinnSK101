...
module.exports = "<div class=\"admin-page background-tint\">\r\n  <div class=\"padding-admin\">\r\n    <div class=\"row mt-5 ml-0 mr-0\">\r\n      <div class=\"col-md-6 maxsize\">\r\n        <div class=\"card\">\r\n          <h2 class=\"text-center mt-4\">Quinn-Admin</h2>\r\n          <div class=\"card-body mb-4\">\r\n            <form [formGroup]=\"adminForm\">\r\n              <ngb-tabset [justify]=\"currentJustify\">\r\n                <ngb-tab class=\"tabset-style\">\r\n                  <ng-template ngbTabTitle><span class=\"tab-title\">Create an account</span></ng-template>\r\n                  <ng-template ngbTabContent>\r\n                    <div class=\"form-group\"></div>\r\n                    <div class=\"form-group\">\r\n                      <input type=\"text\" formControlName=\"name\" class=\"form-control form-control-lg\" placeholder=\"Your Name\">\r\n                    </div>\r\n                    <div class=\"form-group\">\r\n                      <input type=\"email\" formControlName=\"email\" class=\"form-control form-control-lg\" placeholder=\"Your Email\">\r\n                    </div>\r\n                    <div class=\"form-group\">\r\n                      <input type=\"password\" formControlName=\"password\" class=\"form-control form-control-lg\"\r\n                        placeholder=\"Your Password\">\r\n                    </div>\r\n                    <div class=\"form-group\">\r\n                      <input type=\"password\" formControlName=\"confirmPassword\" class=\"form-control form-control-lg\"\r\n                        placeholder=\"Confirm Your Password\">\r\n                      <label class=\"error\">{{errorMessage}}</label>\r\n                      <label class=\"success\">{{successMessage}}</label>\r\n                    </div>\r\n                    <button type=\"submit\" (click)=\"tryRegister(adminForm.value)\" class=\"btn btn-lg btn-block registerTab\">\r\n                      <h4>Register</h4>\r\n                    </button>\r\n                  </ng-template>\r\n                </ngb-tab>\r\n\r\n                <ngb-tab class=\"tabset-style\">\r\n                  <ng-template ngbTabTitle><span class=\"tab-title\">Set permission</span></ng-template>\r\n                  <ng-template ngbTabContent>\r\n                    <div class=\"row mt-5\">\r\n                      <div class=\"col-6 ml-2\">\r\n                        <label>\r\n                          <h5>Name</h5>\r\n                        </label>\r\n                      </div>\r\n                      <div class=\"col-4\">\r\n                        <div ngbDropdown class=\"d-inline-block\">\r\n                          <button class=\"btn btn-outline-primary\" id=\"nameDropdown\" ngbDropdownToggle>{{nameDropdown}}</button>\r\n                          <div ngbDropdownMenu aria-labelledby=\"nameDropdown\">\r\n                            <button class=\"dropdown-item\" (click)=\"onChangeNameDropdown(users.name)\" *ngFor=\"let users of userList\">{{users.name}}</button>\r\n                          </div>\r\n                        </div>\r\n                      </div>\r\n                    </div>\r\n                    <div class=\"row mt-5\">\r\n                      <div class=\"col-6 ml-2\">\r\n                        <label>\r\n                          <h5>Group</h5>\r\n                        </label>\r\n                      </div>\r\n                      <div class=\"col-4\">\r\n                        <div ngbDropdown class=\"d-inline-block\">\r\n                          <button class=\"btn btn-outline-primary\" id=\"groupDropdown\" ngbDropdownToggle>{{groupDropdown}}</button>\r\n                          <div ngbDropdownMenu aria-labelledby=\"groupDropdown\">\r\n                            <button class=\"dropdown-item\" (click)=\"onChangeGroupDropdown('Admin')\">Admin</button>\r\n                            <button class=\"dropdown-item\" (click)=\"onChangeGroupDropdown('Sale Lead')\">Sale\r\n                              Lead</button>\r\n                            <button class=\"dropdown-item\" (click)=\"onChangeGroupDropdown('Sale')\">Sale</button>\r\n                            <button class=\"dropdown-item\" (click)=\"onChangeGroupDropdown('Viewer')\">Viewer</button>\r\n                            <button class=\"dropdown-item\" (click)=\"onChangeGroupDropdown('Annonymous')\">Annonymous</button>\r\n                          </div>\r\n                        </div>\r\n                      </div>\r\n                    </div>\r\n                    <div class=\"mt-5\"></div>\r\n                    <label class=\"mt-4 error\">{{setPermissionErrorMessage}}</label>\r\n                    <label class=\"mt-4 success\">{{setPermissionSuccessMessage}}</label>\r\n                    <button type=\"submit\" (click)=\"onClickSaveButton()\" class=\"mt-3 mb-2 btn btn-lg btn-block permissionTab\">\r\n                      <h4>Save</h4>\r\n                    </button>\r\n                  </ng-template>\r\n                </ngb-tab>\r\n\r\n                <!-- <ngb-tab class=\"tabset-style\">\r\n                                    <ng-template ngbTabTitle><span class=\"tab-title\">Log</span></ng-template>\r\n                                    <ng-template ngbTabContent>\r\n                                        <p>Manage Log.</p>\r\n                                    </ng-template>\r\n                                </ngb-tab> -->\r\n              </ngb-tabset>\r\n            </form>\r\n          </div>\r\n        </div>\r\n        <div class=\"row\">\r\n          <div class=\"col-12 text-center\">\r\n            <div class=\"btn mr-5\">\r\n              <a href [routerLink]=\"['/main']\" class=\"button cta\"> <svg id=\"arrow\" xmlns=\"http://www.w3.org/2000/svg\" x=\"0px\"\r\n                  y=\"0px\" width=\"25\" height=\"25\" viewBox=\"0 5 25 25\" enable-background=\"new 0 0 11.121 19.414\"\r\n                  xml:space=\"preserve\">\r\n                  <path style=\"fill:#E1B77E;\" d=\"M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z\" /></svg> Back to\r\n                Matrix\r\n                page</a>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n"
...
var AdminComponent = /** @class */ (function () {
    function AdminComponent(authService, userService, router, fb) {
    ...
    AdminComponent.prototype.tryRegister = function (value) {
        var _this = this;
    ...
    AdminComponent.prototype.trySaveUser = function (name) {
        var _this = this;
    ...
    AdminComponent.prototype.tryGetAllUsers = function () {
        var _this = this;
        this.userService.getAllUsers()
            .then(function (res) {
            for (var x in res) {
                res.hasOwnProperty(x) && _this.userList.push(res[x]);
            }
            _this.userRes = res;
        }, function (err) {
            console.log(err);
    ...
    AdminComponent.prototype.onChangeNameDropdown = function (name) {
        this.nameDropdown = name;
        this.getUserUid(name);
        this.clearMessage();
    };
    AdminComponent.prototype.onChangeGroupDropdown = function (group) {
        this.groupDropdown = group;
        this.clearMessage();
    };
    AdminComponent.prototype.onClickSaveButton = function () {
        var _this = this;
        this.userService.updatePermission(this.userUid, this.groupDropdown)
            .then(function () {
            _this.setPermissionSuccessMessage = "Update permission success!";
            _this.tryLogSetPermission(_this.userUid, _this.groupDropdown);
            _this.clearDropdown(); /* Must write here because uid will clear too fast */
        }, function (error) {
            _this.setPermissionErrorMessage = error;
            _this.clearDropdown(); /* Must write here because uid will clear too fast */
        });
    };
    AdminComponent.prototype.getUserUid = function (name) {
        var _this = this;
        Object.keys(this.userRes).forEach(function (element) {
            if (name === _this.userRes[element].name) {
                _this.userUid = element;
            }
        });
    };
    AdminComponent.prototype.clearDropdown = function () {
        this.userUid = '';
        this.nameDropdown = "Name";
        this.groupDropdown = "Group";
    };
    AdminComponent.prototype.clearMessage = function () {
        this.setPermissionErrorMessage = '';
        this.setPermissionSuccessMessage = '';
    };
...
var appRoutes = [
    ...
    { path: 'forgotpass', component: _forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_6__["ForgotPasswordComponent"] },
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.logUser = function (uid, userName) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var ref = firebase_app__WEBPACK_IMPORTED_MODULE_3__["database"]().ref("login-log/" + _this.coreService.generateTime());
            ref.set({
                created_date: moment__WEBPACK_IMPORTED_MODULE_4__().format('YYYY-MM-DD'),
                name: userName,
                uid: uid
            }).then(function (res) {
                resolve(res);
    ...
    AuthService.prototype.resetPassword = function (email) {
        return new Promise(function (resolve, reject) {
            ...
            auth.sendPasswordResetEmail(email)
                .then(function () { return resolve("email sent"); })
...
var CoreService = /** @class */ (function () {
    function CoreService(afAuth) {
        this.afAuth = afAuth;
    }
    CoreService.prototype.generateTime = function () {
        var keyTime = moment__WEBPACK_IMPORTED_MODULE_3__().format('YYMMDD-hhmmss');
        return "QN" + keyTime;
    };
...
/***/ "./src/app/core/matrix.service.ts":
/*!****************************************!*\
  !*** ./src/app/core/matrix.service.ts ***!
  \****************************************/
...
var MatrixService = /** @class */ (function () {
    function MatrixService(db, afAuth) {
        this.db = db;
        this.afAuth = afAuth;
    ...
    MatrixService.prototype.reserve = function (building, floor, room, action, userModel) {
        ...
        return new Promise(function (resolve, reject) {
            firebase_app__WEBPACK_IMPORTED_MODULE_4__["database"]().ref(_this.dbPath + '/' + building + '/' + floor + '/' + room + '/').update({
                ...
                resolve(res);
                _this.logMatrix(action, userModel.group, userModel.username, userModel.uid);
            }, function (err) {
                reject(err);
            });
        });
    ...
    MatrixService.prototype.logMatrix = function (action, group, username, uid) {
        var _this = this;
...
var UserService = /** @class */ (function () {
    function UserService(db, afAuth, coreService) {
        this.db = db;
        this.afAuth = afAuth;
        this.coreService = coreService;
        this.dbPath = '/building';
    ...
    UserService.prototype.getUserName = function (uid) {
        return new Promise(function (resolve, reject) {
    ...
    UserService.prototype.getUserDetail = function (uid) {
        return new Promise(function (resolve, reject) {
            var user = firebase_app__WEBPACK_IMPORTED_MODULE_4__["database"]().ref('users/' + uid);
            user.once('value').then(function (res) {
                var name = res.child('name').val();
                var permission = res.child('permission').val();
                var group = res.child('group').val();
                resolve({ name: name, permission: permission, group: group });
            }, function (err) {
                reject(err);
            });
        });
    ...
    UserService.prototype.getAllUsers = function () {
        return new Promise(function (resolve, reject) {
            var user = firebase_app__WEBPACK_IMPORTED_MODULE_4__["database"]().ref('users');
            user.once('value').then(function (res) {
                resolve(res.val());
            }, function (err) {
                reject(err);
    ...
    UserService.prototype.updatePermission = function (uid, group) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            if (_this.isUidEmpty(uid)) {
                reject("Not found user.");
                return;
            }
            if (_this.isGroupEmpty(group)) {
                reject("Please select group.");
                return;
            }
            var groupMap = _this.mapGroup(group);
            var user = firebase_app__WEBPACK_IMPORTED_MODULE_4__["database"]().ref('users/' + uid);
            user.update({
                group: groupMap,
                permission: _this.getPermissionFromGroup(groupMap)
            }).then(function () {
    ...
    UserService.prototype.isUidEmpty = function (uid) {
        return (uid === null || uid === "" || uid === undefined);
    };
    UserService.prototype.isGroupEmpty = function (group) {
        return (group === null || group === "" || group === undefined || group === "Group");
    };
    UserService.prototype.getPermissionFromGroup = function (group) {
        switch (group) {
            case "admin": {
                return 4;
                break;
    ...
    UserService.prototype.mapGroup = function (group) {
        switch (group) {
            case "Admin": {
                return "admin";
                break;
    ...
    UserService.prototype.logSetPermission = function (adminName, group, userName, uid) {
        var _this = this;
        var groupMap = this.mapGroup(group);
        return new Promise(function (resolve, reject) {
            var ref = firebase_app__WEBPACK_IMPORTED_MODULE_4__["database"]().ref("permission-log/" + _this.coreService.generateTime());
            ref.set({
...
module.exports = "<div class=\"reset-page background-tint\">\r\n  <div class=\"padding-reset\">\r\n    <div class=\"row mt-5 ml-0 mr-0\">\r\n      <div class=\"col-lg-6 maxsize\">\r\n        <div class=\"card\">\r\n          <h2 class=\"text-center mt-4\">Forgot password</h2>\r\n          <h5 class=\"text-center\">Please enter email to proceed.</h5>\r\n          <div class=\"card-body\">\r\n            <form [formGroup]=\"resetForm\">\r\n              <div class=\"form-group\">\r\n                <input type=\"email\" formControlName=\"email\" class=\"form-control form-control-lg\" placeholder=\"Your Email\">\r\n                <label class=\"error\">{{errorMessage}}</label>\r\n              </div>\r\n              <button type=\"submit\" (click)=\"resetpassword(resetForm.value.email)\" class=\"btn btn-lg btn-block\">\r\n                <h4>Reset</h4>\r\n              </button>\r\n            </form>\r\n            <!-- <div class=\"row mt-4 ml-0 mr-0\">\r\n              <div class=\"col-12 text-center\">\r\n                <p>No account yet? <a href=\"/register\">Create an account</a></p>\r\n              </div>\r\n            </div> -->\r\n          </div>\r\n        </div>\r\n        <div class=\"row\">\r\n          <div class=\"col-12 text-center\">\r\n            <div class=\"btn mr-5\">\r\n              <a href [routerLink]=\"['/main']\" class=\"button cta\"> <svg id=\"arrow\" xmlns=\"http://www.w3.org/2000/svg\" x=\"0px\" y=\"0px\"\r\n                  width=\"25\" height=\"25\" viewBox=\"0 5 25 25\" enable-background=\"new 0 0 11.121 19.414\" xml:space=\"preserve\">\r\n                  <path style=\"fill:#E1B77E;\" d=\"M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z\" /></svg> Back to\r\n                Login\r\n                page</a>\r\n            </div>\r\n          </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n<ngbd-modal-config #modal (doAction)=\"closeModal($event)\"></ngbd-modal-config>\r\n"
...
var ForgotPasswordComponent = /** @class */ (function () {
    function ForgotPasswordComponent(authService, userService, router, fb) {
        this.authService = authService;
        this.userService = userService;
        this.router = router;
        this.fb = fb;
    ...
    ForgotPasswordComponent.prototype.resetpassword = function (email) {
        ...
        this.authService.resetPassword(email)
            .then(function (res) {
            _this.openModal("Please check your email for reset password.", 'error', 'reset');
        }, function (err) {
            console.log(err);
            _this.errorMessage = err.message;
        });
    };
    ForgotPasswordComponent.prototype.closeModal = function (value) {
        this.router.navigate(['/login']);
    };
    ForgotPasswordComponent.prototype.openModal = function (message, type, action) {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authService, userService, coreService, router, fb) {
        this.authService = authService;
        this.userService = userService;
        this.coreService = coreService;
        this.router = router;
...
/* harmony import */ var _core_auth_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../core/auth.service */ "./src/app/core/auth.service.ts");
/* harmony import */ var _core_matrix_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../core/matrix.service */ "./src/app/core/matrix.service.ts");
...
var MainComponent = /** @class */ (function () {
    function MainComponent(authService, matrixService, userService, router, location) {
        this.authService = authService;
    ...
    MainComponent.prototype.getUser = function () {
        ...
        this.userService.getCurrentUser().then(function (res1) {
            ...
            _this.userService.getUserDetail(res1.uid)
                .then(function (res) {
                _this.userModel.permission = res.permission;
                _this.userModel.username = res.name;
                _this.userModel.group = res.group;
                _this.getData();
            }, function (err2) {
    ...
    MainComponent.prototype.getData = function () {
        var _this = this;
        this.matrixService.getAllData().snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (changes) {
            ...
            _this.openModal("You don't have a permission to view this page. Please contact to administrator.", 'error', 'logout', '');
        });
    };
    ...
    MainComponent.prototype.openModal = function (message, type, action, room) {
        this.modal.open(message, type, action, this.userModel.permission, room);
    };
    MainComponent.prototype.toggleReserve = function (roomdata, room, floor) {
    ...
    MainComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_core_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"],
            _core_matrix_service__WEBPACK_IMPORTED_MODULE_5__["MatrixService"],
            _core_user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"],
...
module.exports = "<div class=\"register-page background-tint\">\r\n  <div class=\"padding-register\">\r\n    <div class=\"row mt-5 ml-0 mr-0\">\r\n      <div class=\"col-md-6 maxsize\">\r\n        <div class=\"card\">\r\n          <h2 class=\"text-center mt-4\">Register</h2>\r\n          <h5 class=\"text-center\">Please enter your email and password to proceed.</h5>\r\n          <div class=\"card-body mb-4\">\r\n            <form [formGroup]=\"registerForm\">\r\n              <div class=\"form-group\">\r\n                <input type=\"text\" formControlName=\"name\" class=\"form-control form-control-lg\" placeholder=\"Your Name\">\r\n              </div>\r\n              <div class=\"form-group\">\r\n                <input type=\"email\" formControlName=\"email\" class=\"form-control form-control-lg\" placeholder=\"Your Email\">\r\n              </div>\r\n              <div class=\"form-group\">\r\n                <input type=\"password\" formControlName=\"password\" class=\"form-control form-control-lg\" placeholder=\"Your Password\">\r\n              </div>\r\n              <div class=\"form-group\">\r\n                <input type=\"password\" formControlName=\"confirmPassword\" class=\"form-control form-control-lg\" placeholder=\"Confirm Your Password\">\r\n                <label class=\"error\">{{errorMessage}}</label>\r\n                <label class=\"success\">{{successMessage}}</label>\r\n              </div>\r\n              <button type=\"submit\" (click)=\"tryRegister(registerForm.value)\" class=\"btn btn-primary btn-lg btn-block\">\r\n                <h4>Register</h4>\r\n              </button>\r\n            </form>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>"
...
/***/ "./src/app/shared/modal/modal-config.css":
/*!***********************************************!*\
  !*** ./src/app/shared/modal/modal-config.css ***!
  \***********************************************/
/*! no static exports found */
...
module.exports = ".close:not(:disabled):not(.disabled):focus,\r\n.close:not(:disabled):not(.disabled):hover {\r\n  outline: none;\r\n}\r\n\r\n.btn-warning {\r\n  background-color: #D6B478;\r\n  border-color: #D6B478;\r\n}\r\n\r\n.btn-danger {\r\n  background-color: #971515;\r\n  border-color: #971515;\r\n}\r\n\r\n.btn-default {\r\n  background-color: #C9C4C1;\r\n  border-color: #C9C4C1;\r\n}\r\n\r\n.btn-info {\r\n  background-color: #13A89E;\r\n  border-color: #13A89E;\r\n}\r\n"

/***/ }),

/***/ "./src/app/shared/modal/modal-config.html":
/*!************************************************!*\
  !*** ./src/app/shared/modal/modal-config.html ***!
  \************************************************/
/*! no static exports found */
...
module.exports = "<ng-template #error let-c=\"close\" let-d=\"dismiss\">\r\n  <div class=\"modal-body text-center\">\r\n    <h1>{{message}}</h1>\r\n  </div>\r\n  <div class=\"modal-footer\" style=\"margin:auto; border: none;\">\r\n    <button type=\"button\" class=\"btn btn-info\" (click)=\"d(); close()\" *ngIf=\"action === 'reset'\">Close</button>\r\n    <button type=\"button\" class=\"btn btn-info\" (click)=\"d(); logout()\" *ngIf=\"action === 'logout'\">Close</button>\r\n    <button type=\"button\" class=\"btn btn-info\" (click)=\"d()\" *ngIf=\"action !== 'reset' && action !== 'logout'\">Close</button>\r\n  </div>\r\n</ng-template>\r\n\r\n<ng-template #prompt let-c=\"close\" let-d=\"dismiss\">\r\n  <div class=\"modal-header\" style=\"border: none;\">\r\n    <button type=\"button\" class=\"close\" aria-label=\"Close\" (click)=\"d()\">\r\n      <span aria-hidden=\"true\">&times;</span>\r\n    </button>\r\n  </div>\r\n  <div class=\"modal-body text-center\">\r\n    <h3>Room: {{room}}<br />{{message}}</h3>\r\n  </div>\r\n  <div class=\"modal-footer\" style=\"margin:auto; border: none;\">\r\n    <button type=\"button\" class=\"btn btn-warning\" (click)=\"confirm('isold')\" *ngIf=\"action === 'available'\">International\r\n      sold</button>\r\n    <button type=\"button\" class=\"btn btn-danger\" (click)=\"confirm('sold')\" *ngIf=\"action === 'available'\">Sold</button>\r\n    <button type=\"button\" class=\"btn btn-default\" (click)=\"available()\" *ngIf=\"action === 'available' && permission > 2\">Not\r\n      available</button>\r\n\r\n    <button type=\"button\" class=\"btn btn-info\" (click)=\"available()\" *ngIf=\"action === 'not-available' && permission > 2\">Confirm</button>\r\n\r\n\r\n    <button type=\"button\" class=\"btn btn-info\" (click)=\"cancel()\" *ngIf=\"action === 'international-sold' && permission > 2\">Confirm</button>\r\n    <button type=\"button\" class=\"btn btn-info\" (click)=\"cancel()\" *ngIf=\"action === 'sold' && permission > 2\">Confirm</button>\r\n  </div>\r\n</ng-template>\r\n"

/***/ }),

/***/ "./src/app/shared/modal/modal-config.ts":
/*!**********************************************!*\
  !*** ./src/app/shared/modal/modal-config.ts ***!
  \**********************************************/
...
var NgbdModalConfig = /** @class */ (function () {
    function NgbdModalConfig(config, modalService) {
        ...
        this.doAction = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.noPermision = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        // customize default values of modals used by this component tree
        config.backdrop = 'static';
        config.keyboard = false;
    }
    NgbdModalConfig.prototype.open = function (message, type, action, permission, room) {
    ...
    NgbdModalConfig.prototype.available = function () {
    ...
    NgbdModalConfig.prototype.confirm = function (todo) {
        if (todo === 'isold') {
    ...
    NgbdModalConfig.prototype.cancel = function () {
    ...
    NgbdModalConfig.prototype.close = function () {
        this.doAction.emit('reset');
        this.modalService.dismissAll();
    };
    NgbdModalConfig.prototype.logout = function () {
    ...
    __decorate([
        ...
        __metadata("design:type", Object)
    ], NgbdModalConfig.prototype, "error", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('prompt'),
        __metadata("design:type", Object)
    ], NgbdModalConfig.prototype, "prompt", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
    ], NgbdModalConfig.prototype, "doAction", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
    ], NgbdModalConfig.prototype, "noPermision", void 0);
    NgbdModalConfig = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'ngbd-modal-config',
            template: __webpack_require__(/*! ./modal-config.html */ "./src/app/shared/modal/modal-config.html"),
            styles: [__webpack_require__(/*! ./modal-config.css */ "./src/app/shared/modal/modal-config.css")],
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyBcL4X6OlhTjvgsjRrDQDOJwCZzJ0S52qA",
        authDomain: "quinnsk-101.firebaseapp.com",
        databaseURL: "https://quinnsk-101.firebaseio.com",
        projectId: "quinnsk-101",
        storageBucket: "quinnsk-101.appspot.com",
        messagingSenderId: "221928841486"
    }
};
/*
...
module.exports = __webpack_require__(/*! C:\Users\Ouiix\Desktop\HallelujaH\quinn-front-end\src\main.ts */"./src/main.ts");
